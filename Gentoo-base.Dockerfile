# Dockerfile (Gentoo Linux Base — systemd)
# Stage 1: Build and customize the rootfs for development (Base)
ARG TARGETPLATFORM
...
# Install essential + development + optional packages (with distfiles cache)
